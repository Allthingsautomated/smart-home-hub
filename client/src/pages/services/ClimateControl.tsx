...
export default function ClimateControl() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <ServiceHeroImage
        src="https://images.unsplash.com/photo-1631545806523-4c13f6f3f0d4?auto=format&fit=crop&w=1400&q=80"
        alt="Modern smart thermostat and climate control in luxury home"
      />
