  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-2xl text-muted-foreground leading-relaxed">
              Optimize energy consumption and reduce operational costs for
      ...
      <ServiceHeroImage
        ...
        alt="Commercial HVAC climate control infrastructure"
      />
        ...
        <div className="container">
          ...
          <div className="mb-20">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              We provide comprehensive energy management solutions designed to
              reduce operational costs while maintaining optimal comfort levels.
              Our systems integrate HVAC control, energy monitoring, and
              building management for maximum efficiency.
            </p>
          </div>
          ...
          <div className="bg-primary/5 p-12 rounded-lg text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Schedule a consultation with our energy management experts to
              discuss how we can reduce your operational costs.
            </p>
            <Button
              size="lg"
