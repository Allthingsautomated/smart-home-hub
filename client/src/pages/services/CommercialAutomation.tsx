  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-2xl text-muted-foreground leading-relaxed">
              Enterprise-level Lutron automation systems for commercial and
      ...
      <ServiceHeroImage
        ...
        alt="Commercial office automation technology and controls"
      />
        ...
        <div className="container">
          ...
          <div className="mb-20">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              We specialize in enterprise-grade Lutron building automation
              systems designed for commercial properties, office buildings, and
              multi-family residential complexes. Our solutions provide
              centralized control, energy efficiency, and professional
          ...
          <div className="bg-primary/5 p-12 rounded-lg text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Schedule a consultation with our commercial automation experts to
              discuss the perfect system for your property.
            </p>
            <Button
              size="lg"
